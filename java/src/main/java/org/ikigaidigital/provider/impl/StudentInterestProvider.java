...
public class StudentInterestProvider implements InterestProvider {

    private static final BigDecimal RATE = new BigDecimal("0.03");
    private static final int NO_INTEREST_DAYS = 30;
    private static final int MAX_ACCRUAL_DAYS = 366;
    ...
    public BigDecimal computeInterest(TimeDeposit td) {
        ...
        if (days > NO_INTEREST_DAYS && days < MAX_ACCRUAL_DAYS) {
